...
/**
 ...
 @see The chapter <a href="http://homepage.sunrise.ch/mysunrise/peterfleury/avr-lcd44780.html" target="_blank">Interfacing a HD44780 Based LCD to an AVR</a>
      on my home page.
  Änderung für Betrieb ohne R/W hinzugefügt. hubert(ät)schorsch.at
*/
...
#define Store_individual_character_from_flash_on_cgram	1   /* activ 1 */
#define print_string_from_EEPROM	1						/* activ 1 */
#define Store_individual_character_from_EEPROM_on_cgram	1	/* activ 1 */
...
#define lcd_busy_time	2000	/* busy_time 5000µsec */
#endif
...
/**
 @brief    scroll string over the display from flash space
 
 @param    x = +20 (shift from right to left), x = -20 (shift from left to right)
 @return   none
*/
extern void scroll_string_flash(int8_t x, uint8_t y, const char *s);

/**
 @brief    scroll string over the display from sram space
 
 @param    x = +20 (shift from right to left), x = -20 (shift from left to right)
 @return   none
*/
extern void scroll_string(int8_t x, uint8_t y, char *s);


#if Store_individual_character_from_flash_on_cgram
/* Store individual character from flash on cgram */
extern void lcd_putc_cgram_p(const char *progmem_s, unsigned char _position);
#endif

#if print_string_from_EEPROM
/* print string from EEPROM */
extern void lcd_puts_eep(const unsigned char *eep); 
#endif

#if Store_individual_character_from_EEPROM_on_cgram
